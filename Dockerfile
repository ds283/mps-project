...
RUN apt-get update && apt-get install -qq -y build-essential gcc mariadb-client mysqltuner libssl-dev libjpeg-dev zlib1g-dev libglpk-dev glpk-utils coinor-cbc --no-install-recommends
