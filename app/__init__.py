...
from .uploads import solution_files, batch_user_files, submitted_files, period_files
...
def create_app():
    ...
    periods_subfolder = Path(app.config.get('ASSETS_PERIODS_SUBFOLDER'))
    ...
    abs_periods_path = asset_folder / periods_subfolder
    abs_periods_path.mkdir(parents=True, exist_ok=True)
    ...
    app.config['UPLOADED_PERIODS_DEST'] = abs_periods_path
    configure_uploads(app, [solution_files, batch_user_files, submitted_files, period_files])
