...
def show_confirmations(outstanding, pclass_id):
    ...
    format_ranking = get_template_attribute(
        "ui_elements/confirm_requests.html", "format_ranking"
    )
    format_confirm_timestamps = get_template_attribute(
        "ui_elements/confirm_requests.html", "format_confirm_timestamps"
    )
    ...
    data = [
        {
            "name": {
                ...
                "sortstring": req.owner.student.user.last_name
                              + req.owner.student.user.first_name,
            },
            ...
            "timestamps": {
                ...
                "timestamp": req.request_timestamp.timestamp()
