        ...
        <div class="dropdown assignment-label">
            ...
            <ul class="dropdown-menu">
                ...
                <li {% if disabled %}class="disabled"{% endif %}>
                    <a {% if not disabled %}href="{{ url_for('convenor.view_feedback', id=r.id, preview=1, text='workload view', url=url_for('convenor.faculty_workload', id=pclass.id)) }}"{% endif %}>Show feedback</a>
                </li>
            ...
            <div class="dropdown assignment-label">
                ...
                <ul class="dropdown-menu">
                    {% for rec in slot.talks %}
                        ...
                        {% set disabled = not pclass.publish %}
                        <li {% if disabled %}class="disabled"{% endif %}>
                            <a {% if not disabled %}href="{{ url_for('convenor.view_feedback', id=rec.id, preview=1, text='workload view', url=url_for('convenor.faculty_workload', id=pclass.id)) }}"{% endif %}>
