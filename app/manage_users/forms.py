...
from app.shared.forms.wtf_validators import (
    ...
    unique_or_original_batch_item_userid,
    unique_or_original_batch_item_email,
...
class UploadBatchCreateForm(Form):
    ...
    trust_registration = BooleanField(
        "Trust imported registration numbers",
        default=False,
...
class EnrollmentRecordMixin:
    ...
    supervisor_reenroll = IntegerField(
        ...
        description="Optional. For faculty on sabbatical or buy-outs, enter a year in which automatic re-enrolment should occur.",
        validators=[Optional()],
    )

    supervisor_comment = TextAreaField(
        "Comment",
        render_kw={"rows": 3},
    ...
    moderator_comment = TextAreaField(
        "Comment",
        render_kw={"rows": 3},
        description="Optional. Use to document sabbaticals, buy-outs and exemptions.",
        validators=[Optional(), Length(max=DEFAULT_STRING_LENGTH)],
    ...
    presentations_comment = TextAreaField(
        "Comment",
        render_kw={"rows": 3},
        description="Optional. Use to document sabbaticals, buy-outs and exemptions.",
        validators=[Optional(), Length(max=DEFAULT_STRING_LENGTH)],
