...
class AuditBackend:
    ...
    def get_audit_records(self, latest: datetime = None) -> DataFrame:
        raise NotImplementedError("The get_audit_records() method should be implemented by concrete AuditBackend instances")

    def delete_audit_records(self, latest: datetime = None) -> None:
        raise NotImplementedError("The delete_audit_records() method should be implemented by concrete AuditBackend instances")
