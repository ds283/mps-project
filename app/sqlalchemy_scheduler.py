...
This source file is adapted from an original in the thirdparty/celery_sqlalchemy_scheduler folder.
For original license conditions, see the original.

Modified by David Seery <D.Seery@sussex.ac.uk>
"""
