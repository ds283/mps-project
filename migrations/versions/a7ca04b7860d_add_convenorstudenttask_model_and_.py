"""Add ConvenorStudentTask model and infrastructure
...
def upgrade():
    ...
    op.create_table('convenor_student_tasks',
    ...
    op.create_index(op.f('ix_convenor_student_tasks_defer_date'), 'convenor_student_tasks', ['defer_date'], unique=False)
    op.create_index(op.f('ix_convenor_student_tasks_due_date'), 'convenor_student_tasks', ['due_date'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_convenor_student_tasks_due_date'), table_name='convenor_student_tasks')
    op.drop_index(op.f('ix_convenor_student_tasks_defer_date'), table_name='convenor_student_tasks')
    op.drop_table('convenor_student_tasks')
    # ### end Alembic commands ###
